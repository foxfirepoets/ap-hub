...
// The exported renderer must name every address it emits at build time, and a tax mapping id is
// only known when someone opens one. One placeholder page is emitted instead, and the shell
// serves it for any tax mapping address (see desktop/renderer.ts — the placeholder name must
