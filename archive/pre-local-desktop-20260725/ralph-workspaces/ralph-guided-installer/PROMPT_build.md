...
Framework: Next.js App Router + React (existing ap-hub app/ tree)
...
If your planned action violates a guardrail (backend/schema/auth touch, recovery key, new
onboarding step, DRY_RUN_LOCKED change, Playwright rewrite): stop, write the conflict to
errors.log, emit:
...
- Do not add a new onboarding step, a recovery-key step, or any backend/schema/auth change.
